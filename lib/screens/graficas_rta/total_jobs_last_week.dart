...
import 'package:graficas_demo/screens/tablas%20pluto/tabla_total_jobs_last_week.dart';
...
class TotalJobsLastWeek extends StatefulWidget {
  ...
  @override
  State<TotalJobsLastWeek> createState() => _TotalJobsLastWeekState();
}

class _TotalJobsLastWeekState extends State<TotalJobsLastWeek> {
  double uti = 67,
      uti1 = 63,
      uti2 = 89,
      uti3 = 115,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Total Jobs Last Week'),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
              ...
              child: Column(
                children: [
                          ...
                          onPressed: () {
                            setState(
                              () {
                                ...
                                weekProvider.setTotalJobsWeek(50);
                              },
                            );
                          },
                          ...
                          onPressed: () {
                            setState(
                              () {
                                ...
                                uti14 = 37;
                                uti15 = 32;
                                weekProvider.setTotalJobsWeek(51);
                              },
                            );
                          },
                          icon: const Icon(Icons.bar_chart),
                          ...
                          onPressed: () => {
                            setState(
                              () {
                                ...
                                uti14 = 37;
                                uti15 = 42;
                                weekProvider.setTotalJobsWeek(52);
                              },
                            ),
                          },
                          icon: const Icon(Icons.bar_chart),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(10),
                    child: Text(
                      'Total Jobs Last Week ${weekProvider.totalJobsWeek}',
                  ...
                  const Flexible(child: TablaTotalJobsLastWeek()),
                ],
              ),
            )
          ],
