...
class _MapaSVGState extends State<MapaSVG> {
  final paths = [
    ['m48.75 95.97-25.91-25.74 14.32-14.57 40.39 40.31z', const Color(0xff02539a)],
    ['m22.52 70.25 25.68-25.68h28.87l-39.95 39.95z',const Color(0xd745d1fd)],
    ['m.29 47.85 14.58 14.57 62.2-62.2h-29.02z',const Color(0xff45d1fd)],
  ...
  Widget build(BuildContext context) {
    var height = MediaQuery.of(context).size.height / 1024;
    var width = MediaQuery.of(context).size.width / 1440;
    const String svgTest =
        '<svg width="1112" height="726" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path fill="url(#a)" d="M.167 0h1111v726H.167z"/><path d="M315 219.141H100V510.5h278.5v80H601V541H490l-1-265H315v-56.859Z" fill="#F39D33" fill-opacity=".2" stroke="#000"/><path d="M378.5 511H100v169h278.5V511Z" fill="#FD6E00" fill-opacity=".2" stroke="#000"/><path d="M880.5 271.5H602v412h348.5l-70-412Z" fill="#215DE7" fill-opacity=".2" stroke="#000"/><path d="M100 219V49.5h215V219H100Z" fill="#3AC170" fill-opacity=".2" stroke="#000"/><path d="M490 275V49H315v226h175Z" fill="#6D5EEB" fill-opacity=".2" stroke="#000"/><path d="M602 541V271H490.5l-.5 270h112Z" fill="#DC389B" fill-opacity=".2" stroke="#000"/><path d="M602 590.5H378V680h224v-89.5Z" fill="#40B9FF" fill-opacity=".2" stroke="#000"/><defs><pattern id="a" patternContentUnits="objectBoundingBox" width="1" height="1"><use xlink:href="#b" transform="scale(.00045 .00069)"/></pattern></defs></svg>';
      ...
      body: Center(
        child: Stack(
          children: [
            ...
            Image.asset(
              'assets/images/Plano Bajanet_page-0001.jpg',
              width: width * 1440,
              height: height * 1024,
            ),
            Column(
