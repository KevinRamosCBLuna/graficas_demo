...
class CustomerRepSales extends StatefulWidget {
  ...
  @override
  State<CustomerRepSales> createState() => _CustomerRepSalesState();
}

class _CustomerRepSalesState extends State<CustomerRepSales> {
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(width: screenWidth, height: 280, child: const TablaCustomerRepSales()),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(10),
                    child: Row(
