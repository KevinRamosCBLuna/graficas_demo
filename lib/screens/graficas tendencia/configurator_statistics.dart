...
class ConfiguratorStatisticsTrend extends StatefulWidget {
  const ConfiguratorStatisticsTrend({Key? key}) : super(key: key);

  @override
  State<ConfiguratorStatisticsTrend> createState() => _TrendServiceState();
}

class _TrendServiceState extends State<ConfiguratorStatisticsTrend> {
