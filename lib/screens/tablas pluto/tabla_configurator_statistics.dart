...
class TablaConfiguratorStatistics extends StatefulWidget {
  const TablaConfiguratorStatistics({Key? key}) : super(key: key);

  @override
  State<TablaConfiguratorStatistics> createState() => _TablaConfiguratorStatisticsState();
}

class _TablaConfiguratorStatisticsState extends State<TablaConfiguratorStatistics> {
  @override
