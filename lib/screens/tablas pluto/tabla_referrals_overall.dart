...
class TablaReferralsOverAll extends StatefulWidget {
  const TablaReferralsOverAll({Key? key}) : super(key: key);

  @override
  State<TablaReferralsOverAll> createState() => _TablaReferralsOverAllState();
}

class _TablaReferralsOverAllState extends State<TablaReferralsOverAll> {
  @override
          ...
          rows: [
            PlutoRow(
              cells: {
                ...
                'CustomerID': PlutoCell(value: 6),
              },
            ),
            PlutoRow(
              cells: {
                'Instance': PlutoCell(value: 'ODE'),
                'CustomerID': PlutoCell(value: 35),
              },
            ),
            PlutoRow(
              cells: {
                'Instance': PlutoCell(value: 'SMI'),
                'CustomerID': PlutoCell(value: 60),
              },
            ),
          ],
